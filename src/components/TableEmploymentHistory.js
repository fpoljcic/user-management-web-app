        ...
        return (
            <div>
                <div className="site-layout-content">
                    <Title style={{ fontFamily: 'Roboto-Thin' }} level={3}>Employment history for {this.state.employeeProfileResponse.name} {this.state.employeeProfileResponse.surname}</Title>
                </div>
                <div>
